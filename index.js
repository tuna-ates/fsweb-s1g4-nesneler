...
function MenuElemaniOlustur(alinanIsim, alinanFiyat, alinanKategori) {
  const nesne = {
    isim: alinanIsim,
    fiyat: alinanFiyat,
    kategori: alinanKategori,
  };
  return nesne;
}
//console.log(MenuElemaniOlustur("döner",10,"ana-yemek"));
...
*/
console.log(MenuElemaniOlustur("döner", 10, "ana-yemek"));
console.log(MenuElemaniOlustur("Tavuk çorbası", 5, "Corba"));
console.log(MenuElemaniOlustur("Tavuk Burger", 15, "Hamburger"));
...
const burger = {
  ...
  indirim:function (özellik){

    if((özellik==="öğretmen")||(özellik==="öğrenci")){
      const indirimli_fiyat=this.fiyat-((this.fiyat*25)/100);
      return indirimli_fiyat;
    }
    else{
      const indirimli_fiyat1=this.fiyat-((this.fiyat*10)/100);
      return indirimli_fiyat1;
    }
  }
};
console.log(burger.indirim("meslek"));
...
function DegerlendirmeEkle(yeniDeğerlendirmeler,alinanisim, alinanpuan,alinangeribildirim) {
  const newObject={
    isim:alinanisim,puan:alinanpuan,geribildirim:alinangeribildirim
  }
